...
function Home() {
    return (
        <>
            ...
            {/* Home Page */}
            <div id='home' className='h-[calc(100vh)] w-full bg-[#000213] flex justify-center pt-[100px]'>
                <div className='w-[90%] flex justify-between items-center'>

                    {/* Left Section */}
                    <motion.div className='h-[80%] flex flex-col ' variants={fadeInLeftVariant}
                        initial="hidden"
                        whileInView="visible">
                        <h1 className='text-3xl font-bold text-white mb-[40px] mt-6'>
                            Hello, I'm <span className="text-[#84AB91] text-6xl font-bold">Ayush Sen!</span>
                        </h1>
                    ...
                    <motion.div className='' variants={fadeInRightVariant}
                        initial="hidden"
                        whileInView="visible"> 
                        <div className=''>
