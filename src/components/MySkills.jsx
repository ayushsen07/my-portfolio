      ...
      <div className="w-[90%] mx-auto">
        ...
        <div className="">
          ...
          <motion.h1 className="sm:text-6xl text-4xl font-bold text-white pb-14"
            ...
            initial="hidden"
            whileInView="visible"
          >What <span className="text-[#84AB91]">I can do</span></motion.h1>
        </div>
            ...
            <motion.div key={index} className=" flex flex-wrap mt-8 gap-5 " variants={fadeInLeftVariant}
              ...
              <div className="flex flex-wrap gap-4">
                {skill.items.map((item, idx) => (
                  <div key={idx} className="flex items-center gap-2 bg-[#19919] text-white px-4 py-2 rounded-lg  border hover:bg-white hover:text-black">
